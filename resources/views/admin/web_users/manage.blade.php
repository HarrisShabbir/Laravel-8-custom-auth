                                ...
                                <tr id="rid{{$user->id}}">     
                                    ...
                                    <td>
                                        @if($user->is_email_verified == 1)
                                            <span class="badge badge-glow bg-success">Verfied</span>
                                        @else    
                                        <span class="badge badge-glow bg-danger">Not Verified</span>
                                        @endif
                                    </td>                                 
                                    <td>{{ date("l M, Y H:i A",strtotime($user->email_verified_at)) }}</td>                                    
                                    <td>{{ date("l M, Y H:i A",strtotime($user->created_at)) }}</td>
                                    {{-- <th>
                                        @can('fact_edit')
