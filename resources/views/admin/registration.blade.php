                            ...
                            <div class="auth-inner my-2">
                                ...
                                <div class="card mb-0">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-1">Register Yourself 🚀</h4>
                                        <p class="card-text mb-2">Register to get most benefits of aur services</p>

                                        <form class="auth-register-form mt-2" action="{{route('postregistration')}}" method="POST">
                                            @csrf
                                            <div class="mb-1">
